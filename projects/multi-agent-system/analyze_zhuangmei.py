...
"""
妆妹海外市场战略分析
使用 DeepInsight Core 系统分析妆妹项目是否值得做海外市场
"""
...
print("=" * 70)
print("DeepInsight Core - 妆妹海外市场战略分析")
print("=" * 70)
...
# 战略问题
question = "妆妹 (AI 美妆闺蜜 App) 是否值得进入海外市场？目标用户是 18-35 岁女性，核心功能是语音交互 + 妆容建议 + 情感陪伴，定价$9.99/月。请分析市场规模、竞争格局、进入策略和风险。"
...
print(f"平均成功概率：{decision_package['average_success_probability']*100:.1f}%")
